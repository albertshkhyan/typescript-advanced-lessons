 ...
 */
const cars2 = ['Ford', 'Audi']; //in type script we have special classes example Array we can this use as type. in this <> we specify which must containe our array
...
function mergeObjects4(a, b) {
    return Object.assign({}, a, b);
}
function withCount2(value) {
    return {
        value,
        count: `In this object we have ${value.length} symbols.`,
    };
}
